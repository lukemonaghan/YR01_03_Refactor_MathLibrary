...
bool  Matrix3::InverseGet(Matrix3 &mat3)const{
	float fDeterm = Determinant();
	if (fDeterm != 0.0f){
		const float fInvDet = Recipf(fDeterm);
...
//translate 
	void Matrix3::TranslateX ( float scalar){
	m00 =   1.0f; m01 =   0.0f; m02 = scalar;
	m10 =   0.0f; m11 =   1.0f; m12 =   1.0f;
	m20 =   0.0f; m21 =   0.0f; m22 =   1.0f;
	}
	void Matrix3::TranslateY ( float scalar){
	m00 =   1.0f; m01 =   0.0f; m02 =   1.0f;
	m10 =   0.0f; m11 =   1.0f; m12 = scalar;
	m20 =   0.0f; m21 =   0.0f; m22 =   1.0f;
	}
	void Matrix3::TranslateXY ( Vector2 vect){
	m00 =   1.0f; m01 =   0.0f; m02 = vect.x;
	m10 =   0.0f; m11 =   1.0f; m12 = vect.y;
	m20 =   0.0f; m21 =   0.0f; m22 =   1.0f;
	}
//ortho
void  Matrix3::Ortho(){
...
//overloads
//Comparitors
bool    Matrix3::operator   == (Matrix3 mat3)const{
	if (m00 == mat3.m00 &&
	    m01 == mat3.m01 &&
	    m02 == mat3.m02 &&
	    m10 == mat3.m10 &&
...
Matrix3 Matrix3::operator   +  (Matrix3 mat3)const{
...
Vector3 Matrix3::operator   *  (Vector3 vect)const{

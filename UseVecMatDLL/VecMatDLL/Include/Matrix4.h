...
#ifndef _MATRIX4_DLL_
#define MATRIX4DLL __declspec(dllexport)
#else
#define MATRIX4DLL __declspec(dllimport)
#endif
...
public:
	...
	void TranslateZ ( float scalar);
	void TranslateXYZ ( Vector3 vect);
